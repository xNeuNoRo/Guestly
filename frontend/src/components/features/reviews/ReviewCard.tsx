...
export function ReviewCard({
  ...
  // Formateo de fecha eficiente (e ej: "15 de octubre de 2025")
      ...
      <header className="flex items-start justify-between mb-5">
        ...
        {isAuthor && (
          <div className="relative z-10" ref={menuRef}>
            <button
              onClick={toggle}
              className={`p-2 rounded-full transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 ${
                value
                ...
                >
                  <div className="p-1.5 flex flex-col gap-1">
                    <button
                      ...
                      className="w-full flex items-center gap-3 px-3 py-2.5 text-sm font-medium text-slate-700 hover:bg-slate-50 hover:text-slate-900 rounded-xl transition-colors text-left"
                    >
